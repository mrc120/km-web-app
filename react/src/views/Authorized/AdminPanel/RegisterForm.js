...
import { vusername, vpassword, required } from "../../../Form/validation"
    ...
    <Form onSubmit={handleRegister} ref={form}>
      ...
      {!successful && (
        <div className="form-group">
          ...
          />
          <CheckButton ref={checkBtn} className="mt-4 mb-5 btn btn-fill btn-primary btn-block">Utwórz konto</CheckButton>
        </div>
      )}
